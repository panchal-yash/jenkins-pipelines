    ...
    library changelog: false, identifier: "lib@ps-pt-molecule", retriever: modernSCM([
        $class: 'GitSCMSource',
    ...
    parameters {
        choice(
            choices: ['ps_80', 'ps_lts_innovation','client_test'],
    ...
    options {
        ...
        stages {
            ...
            stage('Checkout') {
                steps {
                    deleteDir()
                    git poll: false, branch: "ps-pt-molecule", url: "https://github.com/panchal-yash/package-testing.git"
                }
            }
