library changelog: false, identifier: 'lib@wip-pxc-package-testing-upgrade-molecule-spot', retriever: modernSCM([
    $class: 'GitSCMSource',
...
void installDependencies() {
    ...
    sh '''
        ...
        git clone https://github.com/panchal-yash/package-testing --branch wip-pxc-package-testing-upgrade-molecule-spot
    '''
